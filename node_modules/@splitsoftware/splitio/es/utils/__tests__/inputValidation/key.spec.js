...
var errorMsgs = {
  ...
  LONG_KEY: function LONG_KEY(keyType) {
    ...
    return _concatInstanceProperty(_context = "".concat(keyType, " too long, ")).call(_context, keyType, " must be 250 characters or less.");
  },
  NULL_KEY: function NULL_KEY(keyType) {
    var _context2;

    return _concatInstanceProperty(_context2 = "you passed a null or undefined ".concat(keyType, ", ")).call(_context2, keyType, " must be a non-empty string.");
  },
  WRONG_TYPE_KEY: function WRONG_TYPE_KEY(keyType) {
    var _context3;

    return _concatInstanceProperty(_context3 = "you passed an invalid ".concat(keyType, " type, ")).call(_context3, keyType, " must be a non-empty string.");
  },
  NUMERIC_KEY: function NUMERIC_KEY(keyType, value) {
    var _context4;

    return _concatInstanceProperty(_context4 = "".concat(keyType, " \"")).call(_context4, value, "\" is not of type string, converting.");
  },
...
var invalidKeys = [{
  ...
  key: _repeatInstanceProperty(_context5 = 'a').call(_context5, 251),
