...
function _default(startWithTT, mock, assert) {
  ...
  var finished =
  /*#__PURE__*/
  _regenerator.default.mark(function f() {
  ...
  var getTreatmentsAssertions =
  /*#__PURE__*/
  function () {
    var _ref = (0, _asyncToGenerator2.default)(
    /*#__PURE__*/
    _regenerator.default.mark(function _callee(client, expect) {
  ...
  var trackAssertions = function trackAssertions() {
    ...
    mock.onPost(settings.url('/events/bulk')).replyOnce(function (req) {
      var events = JSON.parse(req.data);
