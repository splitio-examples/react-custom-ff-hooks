...
function sanitizeArray(val) {
  var arr = (0, _isArray.default)(val) ? (0, _lang.uniq)((0, _map.default)(val).call(val, function (e) {
    return e + '';
  })) : [];
...
function sanitizeValue(matcherTypeID, value, dataType, attributes) {
  ...
  log.debug((0, _concat.default)(_context = (0, _concat.default)(_context2 = "Attempted to sanitize [".concat(value, "] which should be of type [")).call(_context2, dataType, "]. \n Sanitized and processed value => [")).call(_context, sanitizedValue instanceof Object ? (0, _stringify.default)(sanitizedValue) : sanitizedValue, "]"));
