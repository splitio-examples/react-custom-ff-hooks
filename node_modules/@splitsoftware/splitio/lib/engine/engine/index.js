...
var engine = {
  ...
  getTreatment: function getTreatment(key, seed, treatments, algoId) {
    ...
    log.debug((0, _concat.default)(_context = (0, _concat.default)(_context2 = (0, _concat.default)(_context3 = (0, _concat.default)(_context4 = "[engine] using algo ".concat(algoId !== MURMUR_ID ? 'legacy' : 'murmur', " bucket ")).call(_context4, bucket, " for key ")).call(_context3, key, " using seed ")).call(_context2, seed, " - treatment ")).call(_context, treatment));
    return treatment;
  },
