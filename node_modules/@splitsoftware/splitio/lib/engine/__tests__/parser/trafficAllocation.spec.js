...
**/
(0, _tapeCatch.default)('PARSER / if user is in segment all 100%:on but trafficAllocation is 0%',
/*#__PURE__*/
function () {
...
(0, _tapeCatch.default)('PARSER / if user is in segment all 100%:on but trafficAllocation is 99% with bucket below 99',
/*#__PURE__*/
function () {
...
(0, _tapeCatch.default)('PARSER / if user is in segment all 100%:on but trafficAllocation is 99% and bucket returns 100',
/*#__PURE__*/
function () {
...
(0, _tapeCatch.default)('PARSER / if user is whitelisted and in segment all 100%:off with trafficAllocation as 0%',
/*#__PURE__*/
function () {
