...
/*: Function */
{
  ...
  /*: boolean */
  {
    ...
    log.debug((0, _concat.default)(_context = (0, _concat.default)(_context2 = "[containsAllMatcher] ".concat(runtimeAttr, " contains all elements of ")).call(_context2, ruleAttr, "? ")).call(_context, containsAll));
    return containsAll;
  };
}
