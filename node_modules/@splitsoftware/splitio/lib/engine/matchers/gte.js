...
/*: Function */
{
  ...
  /*: boolean */
  {
    ...
    log.debug((0, _concat.default)(_context = (0, _concat.default)(_context2 = "[greaterThanEqualMatcher] is ".concat(runtimeAttr, " greater than ")).call(_context2, ruleAttr, "? ")).call(_context, isGreaterEqualThan));
