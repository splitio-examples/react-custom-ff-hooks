  ...
  function segmentMatcher(key) {
    ...
    if ((0, _thenable.default)(isInSegment)) {
      isInSegment.then(function (result) {
        ...
        log.debug((0, _concat.default)(_context = (0, _concat.default)(_context2 = "[asyncSegmentMatcher] evaluated ".concat(segmentName, " / ")).call(_context2, key, " => ")).call(_context, isInSegment));
        return result;
      });
    } else {
      var _context3, _context4;

      log.debug((0, _concat.default)(_context3 = (0, _concat.default)(_context4 = "[segmentMatcher] evaluated ".concat(segmentName, " / ")).call(_context4, key, " => ")).call(_context3, isInSegment));
    }
