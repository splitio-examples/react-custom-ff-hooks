...
/*: Function */
{
  ...
  /*: boolean */
  {
    ...
    var _loop = function _loop(i) {
      ...
      if ((0, _findIndexInstanceProperty(_lang))(ruleAttr, function (e) {
    ...
    log.debug((0, _concat.default)(_context = (0, _concat.default)(_context2 = "[equalToSetMatcher] is ".concat(runtimeAttr, " equal to set ")).call(_context2, ruleAttr, "? ")).call(_context, isEqual));
    return isEqual;
  };
}
