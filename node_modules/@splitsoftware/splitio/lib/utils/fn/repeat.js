...
function repeat(fn, delay) {
  ...
  function next() {
    ...
    if (!stopped) {
      ...
      tid = (0, _setTimeout2.default)(function () {
        fn.apply(void 0, (0, _concat.default)(rest).call(rest, [next]));
      }, _delay);
    }
  }
  ...
  till.reset = function () {
    ...
    clearTimeout(tid);
    tid = undefined;
    next.apply(void 0, (0, _concat.default)(_context = [delay]).call(_context, rest));
  };
