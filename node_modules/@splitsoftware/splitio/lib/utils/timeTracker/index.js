...
var TrackerAPI = {
  ...
  start: function start(task, collectors, promise) {
    ...
    if ((0, _thenable.default)(promise)) {
      ...
      result = (0, _bind.default)(_context = this.stop).call(_context, this, task, taskUniqueId);

      if (CALLBACKS[task] && !taskCollector) {
        var _context2;

        // and provide a way for a defered setup of the collector, if needed.
        result.setCollectorForTask = (0, _bind.default)(_context2 = this.setCollectorForTask).call(_context2, this, task, taskUniqueId);
      }
  ...
  stop: function stop(task, modifier) {
    ...
    if (timerData) {
      ...
      logger.debug((0, _concat.default)(_context3 = "[".concat(task, "] took ")).call(_context3, et, "ms to finish.")); // Check if we have a tracker callback.
